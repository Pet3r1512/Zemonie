          ...
          <div className="rounded-2xl bg-white dark:bg-dark-bg shadow-2xl p-8 lg:p-10 space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1.5 text-gray-700 dark:text-gray-300">
                ...
                <li>To generate analytics, charts, and insights from your data</li>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Your data is stored securely using PostgreSQL (via Neon) with Prisma ORM. We use
                industry-standard security measures to protect your information. Authentication is
                handled by Better-Auth, which manages password hashing and session validation.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
                To exercise these rights, you can manage your data through your account settings or
                contact us via our{" "}
                <a
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                account, your personal information and transaction data will be permanently removed
                from our systems.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                13 has provided us with personal data, we will take steps to delete it.
              </p>
            </section>
