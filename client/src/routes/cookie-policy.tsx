        ...
        <div className="rounded-2xl bg-white dark:bg-neutral-950 shadow-2xl p-8 lg:p-10 space-y-8">
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              browser. They help websites remember your preferences and keep you
              logged in.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              Zemonie uses a minimal set of cookies, strictly for authentication
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              The only cookie we use is strictly necessary for the Service to
              function. It allows you to stay logged in as you navigate between
              pages. Without this cookie, you would need to log in again on
              every page visit.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              Note that disabling the session cookie will prevent you from
              staying logged in, and you will need to re-authenticate on each
              visit.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              If you have any questions about this Cookie Policy, please reach
              out via our{" "}
              <a
