        ...
        <div className="rounded-2xl bg-white dark:bg-neutral-950 shadow-2xl p-8 lg:p-10 space-y-8">
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              By accessing or using Zemonie ("the Service"), you agree to be
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              Zemonie is a free personal finance management tool designed for
              Gen Z users. The Service allows you to:
            </p>
            ...
            <div className="mt-4 bg-primary/5 border-l-4 border-primary rounded-r-xl p-4">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-sm">
                Zemonie does <strong>not</strong> collect or store sensitive
                financial information such as bank account numbers, credit card
                details, or phone numbers. All transaction data is entered
                manually by you and used solely for analysis and visualization.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              account credentials. Authentication and session management are
              handled by Better-Auth. You agree to notify us immediately of any
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5 text-gray-700 dark:text-gray-300">
              ...
              <li>
                You are solely responsible for the accuracy of the transaction
                data you enter
              </li>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              The transaction data you enter is used exclusively to generate
              analytics, charts, and insights within your dashboard. We do not
              share your personal financial data with third parties. Aggregated,
              anonymized data may be used to improve the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Zemonie is provided "as is" without any warranty. We are not
              responsible for any financial decisions you make based on the
              analytics provided by the Service. The Service is a tool for
              visualization and tracking, not financial advice.
            </p>
          </section>
