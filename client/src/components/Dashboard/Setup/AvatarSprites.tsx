  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" style={{ display: "none" }}>
      ...
      <symbol id="avatar-fox" viewBox="0 0 100 100">
        ...
        {/* bottom shadow band */}
        <ellipse cx="50" cy="92" rx="46" ry="12" fill="#C07010" opacity="0.35" />
        {/* body */}
        ...
        <ellipse cx="49" cy="55" rx="1.2" ry="0.8" fill="#E86050" opacity="0.7" />
        {/* smile */}
        <path
        ...
        />
        {/* cheek blush */}
        <ellipse cx="26" cy="54" rx="7" ry="4.5" fill="#FF8855" opacity="0.35" />
        <ellipse cx="74" cy="54" rx="7" ry="4.5" fill="#FF8855" opacity="0.35" />
        {/* rim shadow */}
        <ellipse cx="50" cy="90" rx="42" ry="10" fill="#A05800" opacity="0.22" />
        {/* border — dark inner + coloured outer */}
        <circle cx="50" cy="50" r="50" fill="none" stroke="#A06000" strokeWidth="1" opacity="0.5" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#FFD070" strokeWidth="2.5" />
      </symbol>

      {/* 2. Cool Cat */}
      <symbol id="avatar-cat" viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="50" fill="#B3D9F7" />
        <ellipse cx="50" cy="92" rx="46" ry="12" fill="#4A90C0" opacity="0.28" />
        {/* body + sweater */}
        ...
        <line x1="47" y1="42" x2="53" y2="42" stroke="#1A1A1A" strokeWidth="2" />
        {/* lens tint */}
        <rect x="32" y="38" width="14" height="9" rx="4" fill="#2255AA" opacity="0.45" />
        <rect x="54" y="38" width="14" height="9" rx="4" fill="#2255AA" opacity="0.45" />
        {/* lens shine */}
        ...
        <ellipse cx="49" cy="51" rx="1.1" ry="0.7" fill="#E07060" opacity="0.7" />
        {/* whiskers */}
        <line x1="32" y1="54" x2="47" y2="55" stroke="#B0A090" strokeWidth="0.9" />
        <line x1="32" y1="57" x2="47" y2="57" stroke="#B0A090" strokeWidth="0.9" />
        <line x1="68" y1="54" x2="53" y2="55" stroke="#B0A090" strokeWidth="0.9" />
        <line x1="68" y1="57" x2="53" y2="57" stroke="#B0A090" strokeWidth="0.9" />
        {/* smirk */}
        <path
        ...
        <circle cx="50" cy="50" r="50" fill="none" stroke="#3A80B0" strokeWidth="1" opacity="0.5" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#7ACFF0" strokeWidth="2.5" />
      </symbol>

      {/* 3. Happy Panda */}
      <symbol id="avatar-panda" viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="50" fill="#D9F5D6" />
        <ellipse cx="50" cy="92" rx="46" ry="12" fill="#60A860" opacity="0.25" />
        {/* body */}
        ...
        <rect x="69" y="68" width="2" height="30" fill="#88CC88" opacity="0.4" rx="1" />
        <ellipse cx="50" cy="92" rx="42" ry="10" fill="#308830" opacity="0.18" />
        <circle cx="50" cy="50" r="50" fill="none" stroke="#448844" strokeWidth="1" opacity="0.5" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#88DD88" strokeWidth="2.5" />
      </symbol>
      ...
      <symbol id="avatar-bunny" viewBox="0 0 100 100">
        ...
        />
        {/* helmet rim */}
        <circle cx="50" cy="46" r="32" fill="none" stroke="#B0BCEA" strokeWidth="4" />
        <circle cx="50" cy="46" r="32" fill="none" stroke="#E8EEFF" strokeWidth="1.5" />
        ...
        <circle cx="50" cy="50" r="50" fill="none" stroke="#4050A0" strokeWidth="1" opacity="0.6" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#8090D8" strokeWidth="2.5" />
      </symbol>

      {/* 5. Dino Pal */}
      <symbol id="avatar-dino" viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="50" fill="#D4F5D4" />
        <ellipse cx="50" cy="92" rx="46" ry="12" fill="#228830" opacity="0.28" />
        {/* body */}
        ...
        <circle cx="50" cy="50" r="50" fill="none" stroke="#2A7030" strokeWidth="1" opacity="0.5" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#88DD88" strokeWidth="2.5" />
      </symbol>
      ...
      <symbol id="avatar-bear" viewBox="0 0 100 100">
        ...
        <ellipse cx="50" cy="92" rx="46" ry="12" fill="#5030A0" opacity="0.25" />
        {/* robe body */}
        ...
        {/* hat brim */}
        <rect x="23" y="40" width="54" height="8" rx="3.5" fill="#3A2090" opacity="0.5" />
        <rect x="23" y="38" width="54" height="8" rx="3.5" fill="#8050C0" />
        <rect x="24" y="39" width="26" height="3" rx="1.5" fill="#A070E0" opacity="0.4" />
        {/* star on hat */}
        <text x="44" y="24" fontSize="13" fill="#FFD700" fontFamily="sans-serif">
          ★
        </text>
        <text x="44" y="24" fontSize="13" fill="#fff" opacity="0.2" fontFamily="sans-serif">
          ★
        </text>
        {/* ears */}
        ...
        <ellipse cx="42" cy="46" rx="12" ry="7.5" fill="#E0AA70" opacity="0.5" />
        {/* eyes */}
        ...
        <ellipse cx="49" cy="65" rx="1.2" ry="0.8" fill="#AA6030" opacity="0.7" />
        {/* smile */}
        <path
        ...
        <circle cx="50" cy="50" r="50" fill="none" stroke="#5030A0" strokeWidth="1" opacity="0.5" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#A080E0" strokeWidth="2.5" />
      </symbol>

      {/* 7. Robo Buddy */}
      <symbol id="avatar-robot" viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="50" fill="#E8F4F8" />
        <ellipse cx="50" cy="92" rx="46" ry="12" fill="#3090A8" opacity="0.25" />
        {/* body */}
        <rect x="22" y="74" width="56" height="28" rx="8" fill="#6ABCD0" />
        <rect x="24" y="76" width="26" height="10" rx="4" fill="#90D4E8" opacity="0.45" />
        {/* chest light */}
        ...
        <rect x="22" y="24" width="30" height="16" rx="6" fill="#B0E0EE" opacity="0.45" />
        {/* antenna */}
        <line
          x1="50"
          y1="20"
        ...
        {/* eye panels */}
        <rect x="24" y="33" width="20" height="15" rx="5" fill="#0A1828" opacity="0.8" />
        <rect x="56" y="33" width="20" height="15" rx="5" fill="#0A1828" opacity="0.8" />
        <rect x="24" y="32" width="20" height="15" rx="5" fill="#12202A" />
        <rect x="56" y="32" width="20" height="15" rx="5" fill="#12202A" />
        {/* eye glow */}
        <rect x="26" y="34" width="16" height="11" rx="4" fill="#50F0C0" opacity="0.95" />
        <rect x="58" y="34" width="16" height="11" rx="4" fill="#50F0C0" opacity="0.95" />
        {/* scan line */}
        <line x1="28" y1="39" x2="40" y2="39" stroke="#fff" strokeWidth="1.2" opacity="0.5" />
        <line x1="60" y1="39" x2="72" y2="39" stroke="#fff" strokeWidth="1.2" opacity="0.5" />
        {/* eye highlight */}
        ...
        <rect x="33" y="55" width="7" height="7" rx="2" fill="#50F0C0" opacity="0.9" />
        <rect x="44" y="55" width="7" height="7" rx="2" fill="#50F0C0" opacity="0.9" />
        <rect x="55" y="55" width="7" height="7" rx="2" fill="#50F0C0" opacity="0.9" />
        {/* ear bolts */}
        ...
        <circle cx="50" cy="50" r="50" fill="none" stroke="#3090A8" strokeWidth="1" opacity="0.5" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#80D8F0" strokeWidth="2.5" />
      </symbol>
      ...
      <symbol id="avatar-shroom" viewBox="0 0 100 100">
        ...
        <ellipse cx="34" cy="30" rx="16" ry="10" fill="#F07068" opacity="0.55" />
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <circle cx="50" cy="50" r="50" fill="none" stroke="#B02030" strokeWidth="1" opacity="0.5" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#F07070" strokeWidth="2.5" />
      </symbol>

      {/* 9. Ocean Fish */}
      <symbol id="avatar-fish" viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="50" fill="#D6F1FF" />
        <ellipse cx="50" cy="92" rx="46" ry="12" fill="#2068A0" opacity="0.25" />
        {/* water caustic */}
        ...
        {/* scale arcs */}
        <path d="M32 40 Q38 34 44 40" stroke="#E06018" strokeWidth="1" fill="none" opacity="0.5" />
        <path d="M42 36 Q48 30 54 36" stroke="#E06018" strokeWidth="1" fill="none" opacity="0.5" />
        <path d="M26 48 Q32 42 38 48" stroke="#E06018" strokeWidth="1" fill="none" opacity="0.5" />
        {/* eye */}
        ...
        <circle cx="50" cy="50" r="50" fill="none" stroke="#D86020" strokeWidth="1" opacity="0.5" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#F09040" strokeWidth="2.5" />
      </symbol>
      ...
      <symbol id="avatar-owl" viewBox="0 0 100 100">
        ...
        {/* wings */}
        <ellipse cx="26" cy="76" rx="14" ry="22" fill="#28228A" transform="rotate(-18,26,76)" />
        <ellipse cx="74" cy="76" rx="14" ry="22" fill="#28228A" transform="rotate(18,74,76)" />
        <ellipse cx="25" cy="74" rx="13" ry="21" fill="#3030A0" transform="rotate(-18,25,74)" />
        <ellipse cx="73" cy="74" rx="13" ry="21" fill="#3030A0" transform="rotate(18,73,74)" />
        <ellipse
          cx="20"
          cy="66"
          rx="5"
        ...
        <ellipse cx="50" cy="49" rx="22" ry="20" fill="#6A64C8" opacity="0.55" />
        {/* big owl eyes */}
        ...
        <text x="46" y="84" fontSize="13" fill="#FFD700" fontFamily="sans-serif">
          ★
        </text>
        <circle cx="46" cy="76" r="2.5" fill="#FFE880" opacity="0.35" />
        <ellipse cx="50" cy="92" rx="42" ry="10" fill="#06060C" opacity="0.5" />
        <circle cx="50" cy="50" r="50" fill="none" stroke="#3030A0" strokeWidth="1" opacity="0.6" />
        <circle cx="50" cy="50" r="49" fill="none" stroke="#7070D8" strokeWidth="2.5" />
      </symbol>
    </svg>
  );
}
