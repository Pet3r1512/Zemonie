...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("bg-neutral-200 -mx-1 my-1 h-px dark:bg-dark-card", className)}
      {...props}
    />
  );
}
