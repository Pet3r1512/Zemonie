  ...
  return (
    <div
      className={cn(
        ...
        "bg-white dark:bg-dark-bg flex items-center justify-center overflow-hidden",
        className,
      )}
    >
      ...
      <div className="text-center">
        <h2
          className={cn(
            ...
            "font-extrabold tracking-tight relative overflow-hidden text-primary dark:text-white",
            textClassName,
          )}
          style={{ fontSize }}
        >
